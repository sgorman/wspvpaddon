...
function TargetFrame:OnLoad()
	...
	{
		Apollo.LoadForm("TargetFrame.xml", "ClusterTarget", 			"FixedHudStratum", self),
		Apollo.LoadForm("TargetFrame.xml", "ClusterTargetBottomRight", 	"FixedHudStratum", self),
		Apollo.LoadForm("TargetFrame.xml", "ClusterTargetBottomLeft", 	"FixedHudStratum", self),
		Apollo.LoadForm("TargetFrame.xml", "ClusterTargetTopRight", 	"FixedHudStratum", self),
		Apollo.LoadForm("TargetFrame.xml", "ClusterTargetTopLeft", 		"FixedHudStratum", self)
	}
	...
	self.wndAssistFrame = Apollo.LoadForm("TargetFrame.xml", "AssistTarget", "FixedHudStratum", self)
